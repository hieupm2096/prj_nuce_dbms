...
<html lang="en">
    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <div class="content-wrapper">
            <div class="col-lg-12">
                <h1 class="page-header" style="display: inline-block;">Add New Category</h1>
            </div>
            <div class="container-fluid">
                ...
                <div class="card mb-3" style="width: 60%">
                    ...
                    <div class="card-body">
                        <form action="cate_controller.jsp?ac=add" method="POST">
                            <div class="form-group">
                                <label>Category Name:</label>
                                <input name="txtName" type="text" class="form-control" placeholder="enter category name" required/>
                            </div>
                            <c:choose>
