        ...
        <div class="content-wrapper">
            <div class="col-lg-12">
                <a href="book_list.jsp">
                    <h1 class="page-header" style="display: inline-block;">Book List</h1>
                </a>
            </div>
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        ...
                        <form action="book_list.jsp?ac=search" method="POST" style="float: right;">
                                        ...
                                        <tbody>
                                            <c:forEach var="item" items="${result.rows}" varStatus="i">
                                                <tr>
                                                    ...
                                                    <td><a href="book_detail.jsp?id=${item._id}">Detail</a></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
                ...
                <!--Button-->
                <div class="card-md3">
                    <a href="book_add.jsp" class="btn btn-outline-primary btn-primary" style="text-decoration: none; text-transform: none; float: right;">
                        <i class="fa fa-plus">  Add New Book</i>
                    </a>
                </div>
            </div>
            <!-- /.container-fluid-->
