                ...
                <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                    ...
                    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
                        ...
                        <ul class="sidenav-second-level collapse" id="collapseComponents">
                            <li>
                                <a href="cate_list.jsp" style="color: white;">Category</a>
                            </li>
                            <li>
        ...
        <div class="content-wrapper">
            <div class="col-lg-12">
                <a href="cate_list.jsp">
                    <h1 class="page-header" style="display: inline-block;">Category List</h1>
                </a>
            </div>
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        ...
                        <form action="cate_list.jsp?ac=search" method="POST" style="float: right;">
                                        ...
                                        <tbody>
                                            <c:forEach var="item" items="${result.rows}" varStatus="i">
                                                <tr>
                                                    ...
                                                    <td><a href="cate_ud.jsp?id=${item._id}">Update</a></td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
                                    </table>
                ...
                <!--Button-->
                <div class="card-md3">
                    <a href="cate_add.jsp" class="btn btn-outline-primary btn-primary" style="text-decoration: none; text-transform: none; float: right;">
